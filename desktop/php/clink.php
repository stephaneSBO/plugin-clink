...
foreach ($eqLogics as $eqLogic) {
	...
	echo '<img src="plugins/clink/doc/images/clink_icon.png" height="105" width="95" />';
	echo "<br>";
  ...
  <form class="form-horizontal">
    <fieldset>
      ...
      <div class="form-group">
        <label class="col-sm-3 control-label">{{Nom de l'équipement clink}}</label>
        <div class="col-sm-3">
          <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
          <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement clink}}"/>
        </div>
      </div>
      <div class="form-group">
...
<table id="table_cmd" class="table table-bordered table-condensed">
  <thead>
    <tr>
      <th>{{Nom}}</th><th>{{Paramètres}}</th><th>{{Option}}</th><th></th>
    </tr>
  </thead>
  <tbody>
  </tbody>
...
<?php include_file('desktop', 'clink', 'js', 'clink');?>
